...
export const artisanData: Artisan[] = [
  {
    ...
    avatar: '/artisans/vang-thi-mai.jpg',
  ...
  },
  {
    ...
    title: 'Nghệ nhân Ưu tú Dệt Thổ Cẩm',
    ethnic: 'Chăm',
    ...
    story: [
      'Từ năm 12 tuổi, bà Trương đã ngồi bên khung cửi học cách nhuộm màu tự nhiên và nhớ từng đường thoi luồn sợi.',
      'Khác với vải dệt máy công nghiệp vô cảm, mỗi tấm thổ cẩm của bà Trương là sự kết tinh của mồ hôi, lòng thành kính với Mẹ Xứ Sở và sự chính xác đến từng mi-li-mét.',
      'Hiện nay, xưởng dệt của bà là điểm tựa kinh tế vững chắc cho hàng chục phụ nữ Chăm trong làng, nuôi con ăn học thành tài nhờ nghề cổ truyền.'
    ],
    ocopLevel: 4,
    metrics: [
      {
